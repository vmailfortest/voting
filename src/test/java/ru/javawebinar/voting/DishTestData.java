...
public class DishTestData {
    ...
    public static final Dish DISH_3 = new Dish(DISH_1_ID + 2, "Гречка", DATE_YESTERDAY, RESTAURANT_2);
    public static final Dish DISH_4 = new Dish(DISH_1_ID + 3, "Отбивная", DATE_YESTERDAY, RESTAURANT_2);
    public static final Dish DISH_5 = new Dish(DISH_1_ID + 4, "Бутерброд", DATE_TODAY, RESTAURANT_1);
    public static final Dish DISH_6 = new Dish(DISH_1_ID + 5, "Чай", DATE_TODAY, RESTAURANT_1);
    public static final Dish DISH_7 = new Dish(DISH_1_ID + 6, "Гречневые блины", DATE_TODAY, RESTAURANT_2);
    public static final Dish DISH_8 = new Dish(DISH_1_ID + 7, "Компот", DATE_TODAY, RESTAURANT_2);

    public static final List<Dish> DISHES = List.of(DISH_1, DISH_2, DISH_3, DISH_4, DISH_5, DISH_6, DISH_7, DISH_8);

    public static Dish getNew() {
        return new Dish("Созданный ресторан", DATE_TODAY, RESTAURANT_1);
    }

    public static Dish getUpdated() {
        return new Dish(DISH_1_ID, "Планета чебуреков-2", DATE_TODAY, RESTAURANT_1);
    }
